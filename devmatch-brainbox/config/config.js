...
export const errorMessages = {
  ...
  INVALID_NOTIFICATION_UPDATE_ERROR:
    "Invalid notification request, either notification id or type is required!",
...
export const successMessages = {
  ...
  FETCH_PROFILE_SUCCESS: "Profile fetched!",
  USER_UPDATE_SUCCESS: "User updated!",
  CONNECTION_REQUEST_SUCCESS: "Connection request sent!",
  VIEW_CONNECTION_REQUEST_SUCCESS: "Connection requests fetched!",
  EXPLORE_DATA_FETCH_SUCCESS: "Explore data fetched!",
  NOTIFICATION_FETCH_SUCCESS: "Notifications fetched!",
  NOTIFICATION_READ_SUCCESS: "Notifications read!",
  ACCOUNT_DELETION_SUCCESS: "Account deleted!",
  FETCH_CHATS_SUCCESS: "Chats fetched!",
  FETCH_GROUP_CHATS_SUCCESS: "Group chats fetched!",
  FETCH_CHAT_MESSAGES_SUCCESS: "Chat messages fetched!",
