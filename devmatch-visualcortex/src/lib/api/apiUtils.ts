...
export const apiUrls = {
  ...
  deleteAccount: `${BASE_API_URL}/user/delete-account`,
  viewProfile: `${BASE_API_URL}/profile/view`,
  updateProfile: `${BASE_API_URL}/profile/update`,
  updatePassword: `${BASE_API_URL}/profile/update-password`,
  ...
  chats: `${BASE_API_URL}/conversation/chats`,
  groupChats: `${BASE_API_URL}/conversation/groups-chats`,
} as const;
