...
const SentChatBubble = () => {
  ...
  return (
    <div className="place-items-end gap-x-3 grid grid-cols-[1fr_auto] py-1">
      ...
      <div className="before:-right-2 before:bottom-0 before:absolute relative col-start-1 row-end-3 shadow shadow-glass-shadow-medium px-4 py-2 rounded-xl rounded-ee-none w-fit before:w-3 min-w-10 max-w-[90%] before:h-3 min-h-8 text-glass-text-primary before:content-[''] before:rotate-y-180 before:scale-x-[-1] bg-glass-accent-green-bright before:bg-glass-accent-green-bright before:[clip-path:polygon(100%_87%,85%_100%,8%_100%,0%_0%,4%_0%,8%_19%,14%_38%,31%_42%,100%_87%)]">
        I hate you!
      </div>
