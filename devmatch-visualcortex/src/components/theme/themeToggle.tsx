  ...
  return (
    ...
    >
      <input
        type="checkbox"
        id="theme-toggle"
        checked={switchTheme === THEMES.dark ? true : false}
      ...
      >
        <svg
          className={`top-1 left-1 z-50 absolute ${
            switchTheme === THEMES.dark ? "fill-[#7e7e7e]" : "fill-white"
        ...
        >
          <path
            ...
            className={`${
              switchTheme === THEMES.dark ? "stroke-[#7e7e7e]" : "stroke-white"
        ...
        <svg
          className={`top-1 left-11 z-50 absolute ${
            switchTheme === THEMES.dark ? "fill-white" : "fill-[#7e7e7e]"
          } w-4 transition-all duration-500`}
          viewBox="0 0 24 24"
          fill="currentColor"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            ...
            className={`${
              switchTheme === THEMES.dark ? "stroke-white" : "stroke-[#7e7e7e]"
            } transition-all duration-500`}
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
