...
const ProfileDetailsUpdateDropdown = ({
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`absolute flex flex-col bg-glass-surface-light shadow-glass-shadow-heavy shadow-md backdrop-blur-md my-2 p-1 border rounded-xl w-max text-glass-text-primary text-center dropdown-menu`}
        id={id}
        popover="auto"
