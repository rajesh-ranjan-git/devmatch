...
const ContextMenu = ({
  ...
  return (
    <>
      <div
        className={`fixed inset-0 bg-black/80 z-50 transition-opacity duration-500 animate-[fadeIn_0.5s_ease-in-out] ${
