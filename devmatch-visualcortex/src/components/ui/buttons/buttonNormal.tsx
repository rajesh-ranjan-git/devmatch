...
const ButtonNormal = ({
  ...
  return (
    <div
      className={`before:top-1/2 before:left-1/2 before:absolute relative before:bg-[rgba(43,210,255,0.8)] before:rounded-xl hover:before:rounded-4xl w-40 before:w-12 hover:before:w-full h-10 before:h-12 hover:before:h-full before:content-[''] before:rotate-45 hover:before:rotate-0 before:transition-all before:-translate-x-1/2 before:-translate-y-1/2 hover:before:-translate-x-1/2 hover:before:-translate-y-1/2 before:duration-500 before:pointer-events-none select-none before:[box-shadow:0_0_0.3rem_rgba(43,210,255,0.8),0_0_1rem_rgba(43,210,255,0.8),0_0_2rem_rgba(43,210,255,0.8),0_0_3.5rem_rgba(43,210,255,0.8)] cursor-pointer ${className}`}
      onClick={onClick}
    >
