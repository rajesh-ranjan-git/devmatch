...
const Sheet = ({ open, onClose, children }: SheetProps) => {
  ...
  return (
    <>
      ...
      <div
        className={`top-0 right-0 z-50 fixed p-2 bg-glass-surface-light backdrop-blur-sm border rounded-l-xl w-96 h-screen font-semibold text-glass-text-primary text-2xl transition-transform duration-500 ease-in-out animate-[slideInFromRight_0.5s_ease-in-out] ${
