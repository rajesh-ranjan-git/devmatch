...
const Sheet = ({ open, onClose, children }: SheetProps) => {
  ...
  return (
    <>
      ...
      <div
        className={`top-0 right-0 z-50 fixed bg-glass-surface-light backdrop-blur-sm p-2 border rounded-l-xl w-96 h-screen overflow-hidden font-semibold text-glass-text-primary text-2xl transition-transform animate-[slideInFromRight_0.5s_ease-in-out] duration-500 ease-in-out ${
