...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="top-4 right-4 absolute data-[state=open]:bg-secondary opacity-70 hover:opacity-100 rounded-xs focus:outline-hidden hover:ring-1 hover:ring-ring ring-offset-background hover:ring-offset-1 transition-opacity cursor-pointer disabled:pointer-events-none">
